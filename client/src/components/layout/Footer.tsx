  ...
  return (
    <footer className="footer">
      <div className="footer-inner">
        ...
        <div className="footer-links-group"><p className="footer-group-title">Conhecer o Marcamar</p><Link href="/como-funciona"><span className="footer-link">Como funciona</span></Link><Link href="/seguranca"><span className="footer-link">Segurança</span></Link><Link href="/ajuda"><span className="footer-link">Ajuda</span></Link></div>
